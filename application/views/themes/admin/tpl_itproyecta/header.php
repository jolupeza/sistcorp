    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="span7" id="logo">
                <h3><?php echo anchor(site_url(), img(array('src' => 'assets/admin/tpl_itproyecta/img/logo.png', 'alt' => 'SISTEMA ADMINISTRATIVO - SISTCORP')) . 'SISTEMA ADMINISTRATIVO - SISTCORP', array('title' => 'SISTEMA ADMINISTRATIVO - SISTCORP')); ?></h3>
            </div>
            <!-- Fin #logo -->
